    ...
    TitleTextShadow.Text = "anonymos_6"..version
    ...
    CreditText.Text = "Made by anonymos_6"
    ...
    ToggleServerKill.Text = "Kill all"
    ...
    DisplayText("Loaded Fling GUI "..version, "Made by anonymos_6", 3)
    return nil
